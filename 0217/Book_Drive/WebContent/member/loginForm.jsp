	...
	<div class="login-page">
		<div class="form">
			...
			<img src="/bdstyle/image/Book.png"  width="150px"><br><br><br>
				...
				<br><br>
				<div id="footer">
				<a href="#" onclick="window.open('member/idFind.jsp?openInit=true','a','width=400, height=400');">아이디 찾기</a>&nbsp;&nbsp;|&nbsp;&nbsp;
				<a href="#" onclick="window.open('member/pwFind.jsp?openInit=true','a','width=400, height=400');">비밀번호 찾기</a>&nbsp;&nbsp;|&nbsp;&nbsp;
