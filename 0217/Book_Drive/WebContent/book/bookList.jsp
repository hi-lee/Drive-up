					...
					<div class="result">
						...
						<div class="viewOptions">
							...
							<div class="briefHeader sort">
								...
								<div class="sortOptions">
									...
									<form id="searchOption" name="searchOption" action="#" method="get">
										<fieldset>
											<legend>Search Option</legend>
											
											<input type="hidden" name="msc" value="10000"> 
											<select id="oi" name="oi" class="searchOpt2 selectBox" title="항목선택"
												style="display: none;">
											...
											<select id="os" name="os" class="searchOpt2 selectBox"
												title="정렬" style="display: none;">
												<option value="">정렬</option>
												<option value="ASC">오름차순</option>
												<option value="DESC">내림차순</option>
											</select> 
											<select id="cpp" name="cpp" class="searchOpt2 selectBox"
						...
						<form name="briefFrm" method="post"
							...
							<fieldset>
								...
								<c:set var="replace_hilight" value="<span class=hilight>${param.value}</span>"/>
								<c:forEach var="list" items="${bookList }" varStatus="status">
								<c:set var="bookname" value="${fn:replace(list.bookName, param.value, replace_hilight)}"/>
									<li id="item_CATTOT000000498079" class="items">
										<dl>
											...
											<dd class="book">
												<a href="#">
													...
													src="bdstyle/image/ko/local/bookimages/pre.png"
										...
										<c:choose>
											...
											<c:otherwise>대구광역시립 수성도서관</c:otherwise>
															...
															<span id="availableButton_CAT000000498079_1"
															class="availableBtn enabled">
															<c:choose>
